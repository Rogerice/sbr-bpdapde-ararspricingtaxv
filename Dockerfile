...
# Maven & Dependencias #
########################
FROM artifactory.santanderbr.corp/docker-base/rhel8/javase-17:1.20.2.RELEASE as dependencies
...
## APLICACAO ##
###############
FROM artifactory.santanderbr.corp/docker-base/rhel8/javase-17:1.20.2.RELEASE
ARG APP_PATH
ARG NAME
ARG VERSION
