...
# Maven & Dependencias #
########################
FROM artifactory.santanderbr.corp/docker-base/rhel8/javase-17:1.24.0.RELEASE as dependencies
...
RUN mkdir -p /usr/share/maven /usr/share/maven/ref \
 && curl -fsSL -o /tmp/apache-maven.tar.gz ${BASE_URL}/apache-maven-3.9.3-bin.tar.gz \
...
## APLICACAO ##
###############
FROM artifactory.santanderbr.corp/docker-base/rhel8/javase-17:1.24.0.RELEASE
ARG APP_PATH
ARG NAME
ARG VERSION
